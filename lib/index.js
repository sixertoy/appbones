...
(function () {
    ...
    function createBones(parent, values, data, options) {
        var e, src, dest, content,
            opts = {
                encoding: 'utf8'
            };
                ...
                if (lodash.isString(item)) {
                    ...
                    item.map(function (filepath) {
                        ...
                        if (filepath.indexOf('_') === 0) {
                            try {
                                ...
                                content = lodash.template(content, data, options);
                    ...
                    Object.keys(item).map(function (key) {
                        try {
                            ...
                            createBones(dest, item[key], data, options);
                        } catch (e) {
                            throw new Error(e.message);
                        }
                    });
     ...
     *
     */
    AppBones = function (filepath, config, lodashOptions) {
